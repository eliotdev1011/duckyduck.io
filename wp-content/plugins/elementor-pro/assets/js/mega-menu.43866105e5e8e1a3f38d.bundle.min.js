    ...
    9891: (e, t) => {
      ...
      t.default = class AnchorLinks {
        ...
        followMenuAnchor(e, t) {
          ...
          if (!r.length) return;
          r.hasClass("elementor-menu-anchor") ||
            (l = this.calculateRootMargin(r));
          const a = {
            root: null,
            rootMargin: l,
            threshold: this.buildThreshold(r),
          };
          this.createObserver(s, i, e, a).observe(r[0]);
        }
        ...
        createObserver(e, t, n, i) {
          return new IntersectionObserver((i) => {
            i.forEach((i) => {
              i.isIntersecting
                ? (e.addClass(t), n.attr("aria-current", "location"))
                : (e.removeClass(t), n.attr("aria-current", ""));
            });
          }, i);
        }
      };
      ...
      class MegaMenu extends elementorModules.frontend.handlers.NestedTabs {
        ...
        getDefaultElements() {
          ...
          return (
            ...
            (e.$tabContentsBeforeInterlacing = this.$element.find(
              t.tabContentBeforeInterlacing
            )),
            e
          );
        }
        ...
        onTabClick(e) {
          ...
          if (i !== this.getID().toString()) return;
          const o = this.getSettings("selectors"),
            s = e?.currentTarget,
            r = s?.querySelector(o.tabDropdown),
        ...
        interlaceContainers() {
          const { $tabContentsBeforeInterlacing: e, $menuItems: t } =
            this.getDefaultElements();
          e.each((e, n) => {
            t[e].querySelector(".e-n-menu-content").append(n);
          });
        }
        onDestroy() {
